...
import {
    Pane, majorScale, minorScale, Heading, Spinner, PersonIcon, ArrowLeftIcon, Button, SearchIcon,
} from 'evergreen-ui'
...
export default function Index() {
    ...
    return (
        ...
        >
            ...
            >
                <PersonIcon size={90} marginBottom={12} color="gray800" />
                <Heading size={900} className="hoagie">
                    All of Princeton,<br /><b>one search away</b>.
                </Heading>
                <p>The definitive student directory.</p>
                <div>
                    <Pane
                        display="flex"
